"""
Defines the admin-only API endpoints for managing books, copies, and loans.
"""
...
def handle_create_book():
    """Handles the creation of a new book with an optional image upload."""
...
def handle_update_book(book_id):
    """Handles updating a book's details, including its image."""
...
def handle_delete_book(book_id):
    """Handles soft-deleting a book and its copies."""
...
def handle_add_book_copy(book_id):
    """Adds a new copy for a specific book."""
...
def handle_delete_book_copy(copy_id):
    """Handles soft-deleting a single book copy."""
